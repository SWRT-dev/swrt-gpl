...
enum opt_code
{
  ...
  OPT_g = 1143,                              /* -g */
  OPT_gant = 1144,                           /* -gant */
  OPT_gas_loc_support = 1145,                /* -gas-loc-support */
  OPT_gas_locview_support = 1146,            /* -gas-locview-support */
  /* OPT_gcoff = 1147, */                    /* -gcoff */
  /* OPT_gcoff1 = 1148, */                   /* -gcoff1 */
  /* OPT_gcoff2 = 1149, */                   /* -gcoff2 */
  /* OPT_gcoff3 = 1150, */                   /* -gcoff3 */
  OPT_gcolumn_info = 1151,                   /* -gcolumn-info */
  OPT_gdwarf = 1152,                         /* -gdwarf */
  OPT_gdwarf_ = 1153,                        /* -gdwarf- */
  OPT_gen_decls = 1154,                      /* -gen-decls */
  OPT_ggdb = 1155,                           /* -ggdb */
  OPT_ggnu_pubnames = 1156,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1157,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1158, /* -ginternal-reset-location-views */
  OPT_gnat = 1159,                           /* -gnat */
  OPT_gnatO = 1160,                          /* -gnatO */
  OPT_gno_ = 1161,                           /* -gno- */
  OPT_gno_pubnames = 1162,                   /* -gno-pubnames */
  OPT_gpubnames = 1163,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1164,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1165,                   /* -gsplit-dwarf */
  OPT_gstabs = 1166,                         /* -gstabs */
  OPT_gstabs_ = 1167,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1168,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1169,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1170,                        /* -gtoggle */
  OPT_gvariable_location_views = 1171,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1172,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1173,                           /* -gvms */
  OPT_gxcoff = 1174,                         /* -gxcoff */
  OPT_gxcoff_ = 1175,                        /* -gxcoff+ */
  OPT_gz = 1176,                             /* -gz */
  OPT_gz_ = 1177,                            /* -gz= */
  OPT_h = 1178,                              /* -h */
  OPT_idirafter = 1179,                      /* -idirafter */
  OPT_imacros = 1180,                        /* -imacros */
  OPT_imultiarch = 1181,                     /* -imultiarch */
  OPT_imultilib = 1182,                      /* -imultilib */
  OPT_include = 1183,                        /* -include */
  OPT_iplugindir_ = 1184,                    /* -iplugindir= */
  OPT_iprefix = 1185,                        /* -iprefix */
  OPT_iquote = 1186,                         /* -iquote */
  OPT_isysroot = 1187,                       /* -isysroot */
  OPT_isystem = 1188,                        /* -isystem */
  OPT_iwithprefix = 1189,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1190,              /* -iwithprefixbefore */
  OPT_k8 = 1191,                             /* -k8 */
  OPT_l = 1192,                              /* -l */
  OPT_lang_asm = 1193,                       /* -lang-asm */
  OPT_mabi_ = 1194,                          /* -mabi= */
  OPT_mabicalls = 1195,                      /* -mabicalls */
  OPT_mabs_ = 1196,                          /* -mabs= */
  OPT_mandroid = 1197,                       /* -mandroid */
  OPT_march_ = 1198,                         /* -march= */
  OPT_mbionic = 1199,                        /* -mbionic */
  OPT_mbranch_cost_ = 1200,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1201,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1202,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1203,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1204,             /* -mcompact-branches= */
  OPT_mdebug = 1205,                         /* -mdebug */
  OPT_mdebugd = 1206,                        /* -mdebugd */
  OPT_mdivide_breaks = 1207,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1208,                  /* -mdivide-traps */
  OPT_mdmx = 1209,                           /* -mdmx */
  OPT_mdouble_float = 1210,                  /* -mdouble-float */
  OPT_mdsp = 1211,                           /* -mdsp */
  OPT_mdspr2 = 1212,                         /* -mdspr2 */
  OPT_meb = 1213,                            /* -meb */
  OPT_mel = 1214,                            /* -mel */
  OPT_membedded_data = 1215,                 /* -membedded-data */
  OPT_meva = 1216,                           /* -meva */
  OPT_mexplicit_relocs = 1217,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1218,                  /* -mextern-sdata */
  OPT_mfix_24k = 1219,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1220,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1221,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1222,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1223,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1224,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1225,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1226,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1227,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1228,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1229,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1230,                 /* -mfp-exceptions */
  OPT_mfp32 = 1231,                          /* -mfp32 */
  OPT_mfp64 = 1232,                          /* -mfp64 */
  OPT_mfpxx = 1233,                          /* -mfpxx */
  OPT_mframe_header_opt = 1234,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1235, */              /* -mfused-madd */
  OPT_mglibc = 1236,                         /* -mglibc */
  OPT_mgp32 = 1237,                          /* -mgp32 */
  OPT_mgp64 = 1238,                          /* -mgp64 */
  OPT_mgpopt = 1239,                         /* -mgpopt */
  OPT_mhard_float = 1240,                    /* -mhard-float */
  OPT_mimadd = 1241,                         /* -mimadd */
  ...
  OPT_mnan_ = 1264,                          /* -mnan= */
  OPT_mno_float = 1265,                      /* -mno-float */
  OPT_mno_flush_func = 1266,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1267,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1268,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1269,                     /* -mno-mips3d */
  OPT_modd_spreg = 1270,                     /* -modd-spreg */
  OPT_mpaired_single = 1271,                 /* -mpaired-single */
  OPT_mplt = 1272,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1273,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1274,               /* -mrelax-pic-calls */
  OPT_mshared = 1275,                        /* -mshared */
  OPT_msingle_float = 1276,                  /* -msingle-float */
  OPT_msmartmips = 1277,                     /* -msmartmips */
  OPT_msoft_float = 1278,                    /* -msoft-float */
  OPT_msplit_addresses = 1279,               /* -msplit-addresses */
  OPT_msym32 = 1280,                         /* -msym32 */
  OPT_msynci = 1281,                         /* -msynci */
  OPT_mtune_ = 1282,                         /* -mtune= */
  OPT_muclibc = 1283,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1284,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1285,                          /* -mvirt */
  OPT_mvr4130_align = 1286,                  /* -mvr4130-align */
  OPT_mxgot = 1287,                          /* -mxgot */
  OPT_mxpa = 1288,                           /* -mxpa */
  OPT_n = 1289,                              /* -n */
  OPT_no_canonical_prefixes = 1290,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1291,              /* -no-integrated-cpp */
  OPT_no_pie = 1292,                         /* -no-pie */
  OPT_noasmopt = 1293,                       /* -noasmopt */
  OPT_nocpp = 1294,                          /* -nocpp */
  OPT_nodefaultlibs = 1295,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1296,                   /* -nostartfiles */
  OPT_nostdinc = 1297,                       /* -nostdinc */
  OPT_nostdinc__ = 1298,                     /* -nostdinc++ */
  OPT_nostdlib = 1299,                       /* -nostdlib */
  OPT_o = 1300,                              /* -o */
  OPT_p = 1301,                              /* -p */
  OPT_pass_exit_codes = 1302,                /* -pass-exit-codes */
  /* OPT_pedantic = 1303, */                 /* -pedantic */
  OPT_pedantic_errors = 1304,                /* -pedantic-errors */
  OPT_pg = 1305,                             /* -pg */
  OPT_pie = 1306,                            /* -pie */
  OPT_pipe = 1307,                           /* -pipe */
  OPT_posix = 1308,                          /* -posix */
  ...
  OPT_profile = 1320,                        /* -profile */
  OPT_pthread = 1321,                        /* -pthread */
  OPT_quiet = 1322,                          /* -quiet */
  OPT_r = 1323,                              /* -r */
  OPT_rdynamic = 1324,                       /* -rdynamic */
  OPT_remap = 1325,                          /* -remap */
  OPT_s = 1326,                              /* -s */
  OPT_save_temps = 1327,                     /* -save-temps */
  OPT_save_temps_ = 1328,                    /* -save-temps= */
  ...
  /* OPT_std_gnu89 = 1381, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1382,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1383,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1384, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1385, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1386,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1387, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1388, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1389, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1390, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1391, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1392,                     /* -std=legacy */
  OPT_symbolic = 1393,                       /* -symbolic */
  OPT_t = 1394,                              /* -t */
  OPT_time = 1395,                           /* -time */
  OPT_time_ = 1396,                          /* -time= */
  OPT_tno_android_cc = 1397,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1398,                 /* -tno-android-ld */

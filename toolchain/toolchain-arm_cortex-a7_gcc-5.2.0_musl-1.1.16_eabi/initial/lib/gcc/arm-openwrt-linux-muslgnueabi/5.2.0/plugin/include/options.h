...
enum opt_code
{
  ...
  OPT_mabi_ = 1139,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1140,             /* -mabort-on-noreturn */
  OPT_mandroid = 1141,                       /* -mandroid */
  ...
  OPT_mcallee_super_interworking = 1152,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1153,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1154,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1155,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1156,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1157,                  /* -mfp16-format= */
  OPT_mfpu_ = 1158,                          /* -mfpu= */
  ...
  OPT_mmusl = 1163,                          /* -mmusl */
  OPT_mneon_for_64bits = 1164,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1165,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1166,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1167,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1168,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1169,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1170,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1171,                   /* -mrestrict-it */
  OPT_msched_prolog = 1172,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1173,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1174,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1175, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1176,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1177,                         /* -mthumb */
  OPT_mthumb_interwork = 1178,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1179,                  /* -mtls-dialect= */
  OPT_mtp_ = 1180,                           /* -mtp= */
  OPT_mtpcs_frame = 1181,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1182,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1183,                         /* -mtune= */
  OPT_muclibc = 1184,                        /* -muclibc */
  OPT_munaligned_access = 1185,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1186,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1187,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1188,              /* -mword-relocations */
  OPT_n = 1189,                              /* -n */
  OPT_no_canonical_prefixes = 1190,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1191,              /* -no-integrated-cpp */
  OPT_nocpp = 1192,                          /* -nocpp */
  OPT_nodefaultlibs = 1193,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1194,                   /* -nostartfiles */
  OPT_nostdinc = 1195,                       /* -nostdinc */
  OPT_nostdinc__ = 1196,                     /* -nostdinc++ */
  OPT_nostdlib = 1197,                       /* -nostdlib */
  OPT_o = 1198,                              /* -o */
  OPT_p = 1199,                              /* -p */

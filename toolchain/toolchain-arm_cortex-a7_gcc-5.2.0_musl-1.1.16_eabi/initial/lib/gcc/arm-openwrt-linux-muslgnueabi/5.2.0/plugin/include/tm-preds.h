/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/paldier/release/qsdk/qsdk/build_dir/toolchain-arm_cortex-a7_gcc-5.2.0_musl-1.1.16_eabi/gcc-5.2.0/gcc/config/arm/arm.md'.  */

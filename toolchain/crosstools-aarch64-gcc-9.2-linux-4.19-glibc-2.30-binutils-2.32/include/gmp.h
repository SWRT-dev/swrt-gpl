...
#define __GMP_CC "/auto/work/joel/local/bin/gcc -std=gnu99"
#define __GMP_CFLAGS "-O2 -I/opt/toolchains/crosstools-aarch64-gcc-9.2-linux-4.19-glibc-2.30-binutils-2.32/include"

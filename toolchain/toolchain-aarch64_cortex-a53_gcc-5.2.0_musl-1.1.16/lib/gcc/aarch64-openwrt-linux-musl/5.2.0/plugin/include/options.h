...
enum opt_code
{
  ...
  OPT_mabi_ = 1139,                          /* -mabi= */
  OPT_march_ = 1140,                         /* -march= */
  OPT_mbig_endian = 1141,                    /* -mbig-endian */
  OPT_mbionic = 1142,                        /* -mbionic */
  OPT_mcmodel_ = 1143,                       /* -mcmodel= */
  OPT_mcpu_ = 1144,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1145,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1146,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1147,             /* -mgeneral-regs-only */
  OPT_mglibc = 1148,                         /* -mglibc */
  OPT_mlittle_endian = 1149,                 /* -mlittle-endian */
  OPT_mmusl = 1150,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1151,       /* -momit-leaf-frame-pointer */

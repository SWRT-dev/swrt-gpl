...
IPQ807X_MODEL_LIST := $(addprefix _,$(addsuffix _,GT-AXY16000 RT-AX89U SWRT-RAX120))

# Select IPQ807X SoC
export HE12_MODEL_LIST := $(addprefix _,$(addsuffix _,RT-AX89U GT-6000N SWRT-RAX120))
...
GCC520_MUSLLIBC32_MODEL_LIST	:=
KERNEL_GCC520_MUSLLIBC32_MODEL_LIST	:=
GCC520_MUSLLIBC64_MODEL_LIST	:= $(addprefix _,$(addsuffix _,RT-AX89U GT-6000N SWRT-RAX120))
KERNEL_GCC520_MUSLLIBC64_MODEL_LIST	:= $(addprefix _,$(addsuffix _,RT-AX89U GT-6000N SWRT-RAX120))
...
export TOOLS := $(SRCBASE)/../../toolchains/toolchain-aarch64_cortex-a53_gcc-5.2.0_musl-1.1.16
export CROSS_COMPILE := $(TOOLS)/bin/aarch64-openwrt-linux-musl-
export READELF := $(TOOLS)/bin/aarch64-openwrt-linux-musl-readelf
else
$(error Needs to define CROSS_COMPILE)
endif
...
ifneq ($(findstring $(_BUILD_NAME_),$(KERNEL_GCC520_MUSLLIBC32_MODEL_LIST)),)
KERNELCC := $(TOOLS)/bin/arm-openwrt-linux-muslgnueabi-gcc
KERNELLD := $(TOOLS)/bin/arm-openwrt-linux-muslgnueabi-ld
else ifneq ($(findstring $(_BUILD_NAME_),$(KERNEL_GCC520_MUSLLIBC64_MODEL_LIST)),)
KERNELCC := $(TOOLS)/bin/aarch64-openwrt-linux-musl-gcc
KERNELLD := $(TOOLS)/bin/aarch64-openwrt-linux-musl-ld
endif

...
include $(WLAN_TreeBaseA)/src-bcm-470x/makefiles/RelPath.mk
...
WLAN_SrcBaseA := $(WLAN_TreeBaseA)/src-bcm-470x
...
include $(WLAN_TreeBaseA)/src-bcm-470x/tools/release/WLAN.usf

...
#define NVRAM_SPACE		(CFG_NVRAM_SIZE - UBOOT_CFG_ENV_SIZE - UBI_OVERHEAD)
#else
#define NVRAM_SPACE		(CFG_NVRAM_SIZE - UBI_OVERHEAD)
#endif
#else
#define NVRAM_SPACE		(0x10000 - UBOOT_CFG_ENV_SIZE - UBI_OVERHEAD)
#endif
...
#if defined(CONFIG_MODEL_RTAX89U) || defined(CONFIG_MODEL_RAX120)

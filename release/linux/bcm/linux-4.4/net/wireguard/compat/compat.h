...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 13, 0) && !defined(ISRHEL7) && !defined(CONFIG_RALINK) && !defined(ARCH_MEDIATEK) && !defined(CONFIG_ARCH_QCOM) && !defined(CONFIG_BCM47XX)

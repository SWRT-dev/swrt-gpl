...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 13, 0) && !defined(ISRHEL7) && !defined(CONFIG_RALINK) && !defined(ARCH_MEDIATEK) && !defined(CONFIG_ARCH_QCOM)
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(5, 8, 0) && !defined(CONFIG_ARCH_MEDIATEK) && !defined(CONFIG_RALINK)
#include <linux/skbuff.h>
#include <linux/ip.h>

	...
	while (Length > 4) {
		...
		case WSC_ID_REGISTRAR_NONCE:
			...
			if (RTMPCompareMemory(pReg->RegistrarNonce, pData, WscLen) != 0)
				MTWF_DBG(pAdapter, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR, "Rx M3 Compare Registrar nonce mismatched\n");
	...
	OUT PWSC_REG_DATA pReg)
{
	...
	while (Length > 4) {
		...
		case WSC_ID_ENROLLEE_NONCE:
			...
			/* for verification with our enrollee nonce */
			if (RTMPCompareMemory(pReg->EnrolleeNonce, pData, WscLen) != 0)
				MTWF_DBG(pAdapter, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_ERROR, "Rx M4 Compare enrollee nonce mismatched\n");
	...
	OUT PWSC_REG_DATA pReg)
{
	...
	while (Length > 4) {
		...
		case WSC_ID_REGISTRAR_NONCE:
			/* for verification with our Registrar nonce */
			if (RTMPCompareMemory(pReg->RegistrarNonce, pData, WscLen) != 0)
				MTWF_DBG(pAdapter, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_INFO, "Rx M5 Compare Registrar nonce mismatched\n");
	...
	OUT PWSC_REG_DATA pReg)
{
	...
	while (Length > 4) {
		...
		case WSC_ID_ENROLLEE_NONCE:
			...
			/* for verification with our enrollee nonce */
			if (RTMPCompareMemory(pReg->EnrolleeNonce, pData, WscLen) != 0)
				MTWF_DBG(pAdapter, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_WARN, "Rx M6 Compare enrollee nonce mismatched\n");
	...
	OUT PWSC_REG_DATA pReg)
{
	...
	while (Length > 4) {
		...
		case WSC_ID_REGISTRAR_NONCE:
			...
			/* for verification with our Registrar nonce */
			if (RTMPCompareMemory(pReg->RegistrarNonce, pData, WscLen) != 0)
				MTWF_DBG(pAdapter, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_WARN, "Rx M5 Compare Registrar nonce mismatched\n");
	...
	IN  PWSC_CTRL pWscControl)
{
	...
	while (Length > 4) {
		...
		case WSC_ID_ENROLLEE_NONCE:
			...
			/* for verification with our enrollee nonce */
			if (RTMPCompareMemory(pReg->EnrolleeNonce, pData, WscLen) != 0)
				MTWF_DBG(pAdapter, DBG_CAT_SEC, CATSEC_WPS, DBG_LVL_WARN, "Rx M8 Compare enrollee nonce mismatched\n");

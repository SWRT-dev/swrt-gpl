	...
	IN MAC_TABLE_ENTRY * pEntry)
{
	...
	os_free_mem(mpool);
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "<=== send Msg1 of 4-way\n");
}
	...
	IN MAC_TABLE_ENTRY * pEntry)
{
	...
	os_free_mem(mpool);
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "<=== send Msg2 of 4-way\n");
}
	...
	IN MAC_TABLE_ENTRY * pEntry)
{
	...
	os_free_mem(mpool);
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "<=== send Msg3 of 4-way\n");
}
...
/* Cache the PMK against PMKID, generated in process_ecdh_element() */
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "<=== send Msg4 of 4-way\n");
}
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "===>Receive msg 1\n");
	if (pEntry == NULL) {
		return;
	}
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "===>Receive msg 2\n");
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "===>Receive msg 3\n");
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "===>Receive msg 4\n");
	...
	IN MLME_QUEUE_ELEM * Elem)
{
	...
	MTWF_DBG(pAd, DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_DEBUG, "===>Receive group msg 1\n");
	pHandshake4Way = &pSecConfig->Handshake;
	/* pointer to 802.11 header*/
	pHeader = (PHEADER_802_11)Elem->Msg;
#ifdef A4_CONN

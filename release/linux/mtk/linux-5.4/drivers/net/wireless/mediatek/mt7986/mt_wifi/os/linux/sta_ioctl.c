					 ...
					 union iwreq_data *wrqu, char *extra)
{
	...
	case IW_AUTH_WPA_VERSION:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s::IW_AUTH_WPA_VERSION - param->value = %d!\n", __func__, param->value);
		break;
	...
	case IW_AUTH_CIPHER_PAIRWISE:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s::IW_AUTH_CIPHER_PAIRWISE - param->value = %d!\n", __func__, param->value);
		break;
	...
	case IW_AUTH_CIPHER_GROUP:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s::IW_AUTH_CIPHER_GROUP - param->value = %d!\n", __func__, param->value);
		break;
	...
	case IW_AUTH_KEY_MGMT:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s::IW_AUTH_KEY_MGMT - param->value = %d!\n", __func__, param->value);
		break;
	...
	case IW_AUTH_PRIVACY_INVOKED:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s::IW_AUTH_PRIVACY_INVOKED - param->value = %d!\n", __func__, param->value);
		break;

	case IW_AUTH_DROP_UNENCRYPTED:
		pIoctlWpa->flags = RT_CMD_STA_IOCTL_WPA_AUTH_DROP_UNENCRYPTED;
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s::IW_AUTH_DROP_UNENCRYPTED - param->value = %d!\n", __func__, param->value);
		break;
	...
	case IW_AUTH_80211_AUTH_ALG:
		...
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s::IW_AUTH_80211_AUTH_ALG - param->value = %d!\n", __func__, param->value);
		break;

	case IW_AUTH_WPA_ENABLED:
		pIoctlWpa->flags = RT_CMD_STA_IOCTL_WPA_AUTH_WPA_ENABLED;
		MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "%s::IW_AUTH_WPA_ENABLED - Driver supports WPA!(param->value = %d)\n", __func__, param->value);
		break;
					 ...
					 union iwreq_data *wrqu, char *extra)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_INFO, "rt_ioctl_giwauth::param->value = %d!\n", param->value);
	return 0;
}

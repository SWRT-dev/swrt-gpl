...
static void ra_6ghe_entry_set(struct _MAC_TABLE_ENTRY *entry, struct _RA_ENTRY_INFO_T *ra_entry)
{
	...
	tx_phy_cfg->BW = ra_entry->ucBBPCurrentBW < cap->ch_bw.he_ch_width ?
					ra_entry->ucBBPCurrentBW : cap->ch_bw.he_ch_width;
	...
	max_phy_cfg->BW = ra_entry->ucBBPCurrentBW < cap->ch_bw.he_ch_width ?
					ra_entry->ucBBPCurrentBW : cap->ch_bw.he_ch_width;

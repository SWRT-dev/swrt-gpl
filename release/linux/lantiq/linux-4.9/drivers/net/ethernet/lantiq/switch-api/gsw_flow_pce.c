...
const PCE_MICROCODE pce_mc_max_ifx_tag_m_31 = {/* V31_09 */
	...
	PCE_MC_M3(0x0000, 0x0000, 113, OUT_APP0, 2, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0300, 0xFF00, 28, OUT_APP1, 2, INSTR, FLAG_SNAP, 0),
	PCE_MC_M3(0x0000, 0x0000, 113, OUT_APP1, 1, INSTR, FLAG_NO, 0),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_ETYPE, 1, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0021, 0xFFFF, 36, OUT_PPP, 1, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0057, 0xFFFF, 46, OUT_PPP, 1, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_PPP, 1, INSTR, FLAG_NO, 0),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_1IP0, 10, INSTR, FLAG_1IPV4, 1),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_1IP4, 6, LENACCU, FLAG_NO, 0),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_1IP3, 17, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x00F8, 58, OUT_NONE, 0, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_NONE, 0, INSTR, FLAG_NO, 0),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_1LNH, 1, IPV6, FLAG_1IPV6EXT, 0),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_2IP0, 10, INSTR, FLAG_2IPV4, 1),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_2IP4, 6, LENACCU, FLAG_NO, 0),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_2IP3, 17, INSTR, FLAG_NO, 0),
	...
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_2LNH, 1, IPV6, FLAG_2IPV6EXT, 0),
	PCE_MC_M3(0x0000, 0x0000, 93, OUT_APP0, 6, INSTR, FLAG_TCP, 0),
	PCE_MC_M3(0x0010, 0x0010, 113, OUT_APP6, 4, INSTR, FLAG_TCPACK, 0),
	PCE_MC_M3(0x0000, 0x0010, 113, OUT_APP6, 4, INSTR, FLAG_NO, 0),
	...
	PCE_MC_M3(0x0043, 0xFFFF, 113, OUT_APP1, 3, INSTR, FLAG_DHCPV4, 0),
	PCE_MC_M3(0x0044, 0xFFFF, 113, OUT_APP1, 3, INSTR, FLAG_DHCPV4, 0),
	PCE_MC_M3(0x0000, 0x0000, 113, OUT_APP1, 3, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x0000, 102, OUT_APP0, 1, INSTR, FLAG_1UDP, 0),
	PCE_MC_M3(0x0222, 0xFFFE, 113, OUT_APP1, 3, INSTR, FLAG_DHCPV6, 0),
	PCE_MC_M3(0x0000, 0x0000, 113, OUT_APP1, 3, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x0000, 113, OUT_APP0, 4, INSTR, FLAG_IGMP, 0),
	PCE_MC_M3(0x0000, 0x0000, 112, OUT_NONE, 0, INSTR, FLAG_ETYPE_888E, 0),
	PCE_MC_M3(0x0082, 0x00FE, 113, OUT_APP0, 2, INSTR, FLAG_IGMP, 0),
	PCE_MC_M3(0x0084, 0x00FF, 113, OUT_APP0, 2, INSTR, FLAG_IGMP, 0),
	PCE_MC_M3(0x008F, 0x00FF, 113, OUT_APP0, 2, INSTR, FLAG_IGMP, 0),
	PCE_MC_M3(0x0097, 0x00FF, 113, OUT_APP0, 2, INSTR, FLAG_IGMP, 0),
	PCE_MC_M3(0x0098, 0x00FE, 113, OUT_APP0, 2, INSTR, FLAG_IGMP, 0),
	PCE_MC_M3(0x0000, 0x0000, 113, OUT_APP0, 2, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x0000, 113, OUT_APP0, 2, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x0000, 114, OUT_1PL, 1, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x0000, 115, OUT_2PL, 1, INSTR, FLAG_NO, 0),
	PCE_MC_M3(0x0000, 0x0000, 115, OUT_NONE, 0, INSTR, FLAG_END, 0),
	PCE_MC_M3(0x0000, 0x0000, 115, OUT_NONE, 0, INSTR, FLAG_END, 0),
	PCE_MC_M3(0x0000, 0x0000, 115, OUT_NONE, 0, INSTR, FLAG_END, 0),
	PCE_MC_M3(0x0000, 0x0000, 115, OUT_NONE, 0, INSTR, FLAG_END, 0),
	PCE_MC_M3(0x0000, 0x0000, 115, OUT_NONE, 0, INSTR, FLAG_END, 0),
...
int gsw_pmicro_code_init(void *cdev)
{
	...
	if (gswdev->gipver == LTQ_GSWIP_3_0) {
	...
	} else if (IS_VRSN_31(gswdev->gipver) && (!gswdev->eg_sptag)) {
		...
		for (i = 0; i < 256 /*PCE_MICRO_TABLE_SIZE*/; i++) {
			memset(&tbl_entry, 0, sizeof(pctbl_prog_t));
			tbl_entry.val[3] = pce_mc_max_ifx_tag_m_31_1[i].val_3;
			tbl_entry.val[2] = pce_mc_max_ifx_tag_m_31_1[i].val_2;
			tbl_entry.val[1] = pce_mc_max_ifx_tag_m_31_1[i].val_1;
			tbl_entry.val[0] = pce_mc_max_ifx_tag_m_31_1[i].val_0;
			tbl_entry.pcindex = i;
			tbl_entry.table = PCE_PARS_INDEX;
			gsw_pce_table_write(cdev, &tbl_entry);
		}
		...
		if (gswdev->prod_id == PRX300) {
			for (i = 0; i < 64 /* PCE_MICRO_TABLE_SIZE */; i++) {
				memset(&tbl_entry, 0, sizeof(tbl_entry));
				tbl_entry.val[3] =
					pce_mc_max_ifx_tag_m_1[i].val_3;
				tbl_entry.val[2] =
					pce_mc_max_ifx_tag_m_1[i].val_2;
				tbl_entry.val[1] =
					pce_mc_max_ifx_tag_m_1[i].val_1;
				tbl_entry.val[0] =
					pce_mc_max_ifx_tag_m_1[i].val_0;
				tbl_entry.pcindex = i;
				tbl_entry.table = PCE_PARS_INDEX;
				gsw_pce_table_write(cdev, &tbl_entry);
			}
		...
		if (gswdev->prod_id == GRX500) {
			for (i = 0; i < 64 /* PCE_MICRO_TABLE_SIZE */; i++) {
				memset(&tbl_entry, 0, sizeof(tbl_entry));
				tbl_entry.val[3] =
					pce_mc_max_ifx_tag_m[i].val_3;
				tbl_entry.val[2] =
					pce_mc_max_ifx_tag_m[i].val_2;
				tbl_entry.val[1] =
					pce_mc_max_ifx_tag_m[i].val_1;
				tbl_entry.val[0] =
					pce_mc_max_ifx_tag_m[i].val_0;
				tbl_entry.pcindex = i;
				tbl_entry.table = PCE_PARS_INDEX;
				gsw_pce_table_write(cdev, &tbl_entry);
			}

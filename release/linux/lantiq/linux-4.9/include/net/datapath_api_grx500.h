...
#define DP_DFL_SESS_NUM 1    /*!< Maximum default egress session per subif */
#define DP_MAX_DEF_Q_PER_SUBIF 1 /*!< Maximum default queue per subif */
...
#define DP_MAX_CTP_PER_DEV  1   /*!< @brief  max CTP per dev:
				 ...
				 *     in pcp mode
				 */
#define DP_MAX_DEQ_PER_SUBIF 1 /*!<@brief the maximum number of dequeue port per

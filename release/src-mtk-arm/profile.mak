...
EXTRACFLAGS := -DLINUX26 -DCONFIG_RALINK -DMUSL_LIBC -DDEBUG_NOISY -DDEBUG_RCTEST -D__UAPI_DEF_ETHHDR -pipe -funit-at-a-time -Wno-pointer-sign -march=armv8-a -mcpu=cortex-a53 -fsigned-char
else

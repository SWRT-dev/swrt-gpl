...
#define SF_CFG1_BRI			((UINT32)0x710)
#define SF_CFG2_BRI			((UINT32)0x714)
#define SF_FDMA_CTL			((UINT32)0x718)
#define SF_FDMA_FADR		((UINT32)0x71C)
#define SF_FDMA_DADR		((UINT32)0x720)
#define SF_FDMA_END_DADR	((UINT32)0x724)
#define SFLASH_FIN_REG	    ((UINT32)0x728) // |0x4

...
#endif
#if !defined(RTAX95Q) && !defined(XT8PRO) && !defined(XT8_V2) && !defined(RTAXE95Q) && !defined(ET8PRO) && !defined(RTAX56_XD4) && !defined(XD4PRO) && !defined(CTAX56_XD4) && !defined(RTAX55) && !defined(RTAX1800) && !defined(RTAX82_XD6S) && !defined(RPAX56) && !defined(RPAX58) && !defined(RTAX58U_V2) && !defined(ET12) && !defined(XT12)
	add_to_list("eth4", ifnames, sizeof(ifnames));
#endif
#if defined(RTCONFIG_EXT_BCM53134) || defined(RTCONFIG_EXTPHY_BCM84880)
#if !defined(RTAX95Q) && !defined(XT8PRO) && !defined(XT8_V2) && !defined(RTAXE95Q) && !defined(ET8PRO) && !defined(ET12) && !defined(XT12)
#if defined(RTAX86U)
...
#endif
	check_wl_country();
#if defined(RTAC3200) || defined(SBRAC3200P) || defined(RTAC68U) || defined(RTCONFIG_BCM_7114) || defined(HND_ROUTER) || defined(DSL_AC68U)
	wl_disband5grp();
#endif
#ifdef HND_ROUTER
	wl_dis_illegal_160m();
...
*/
			...
			else
			{
				...
				if (nvram_match(strcat_r(prefix, "vreqd", tmp2), "1")
					...
					if (nvram_match(strcat_r(prefix, "bw_320", tmp), "1"))
						...
						nvram_set(strcat_r(prefix, "bw_cap", tmp), (hw_vht_cap() || hw_he_cap()) ? "15" : "3");	// 160M
...
#endif
							nvram_set(strcat_r(prefix, "bw_cap", tmp), hw_vht_cap() ? (hw_he_cap() ? "15" : "7") : "3");    // 160M, in rp or wb, ac chip set to 80
					}
					else
#endif
			...
			nvram_match(strcat_r(prefix, "vreqd", tmp2), "1"))
		{
			if (nvram_match(strcat_r(prefix, "nband", tmp), "2"))	// 2.4G
				...
				nvram_set(strcat_r(prefix, "bw_cap", tmp), (hw_vht_cap() || hw_he_cap()) ? "15" : "3");
			nvram_set(strcat_r(prefix, "obss_coex", tmp), "0");
		}
#endif
#if defined(RTCONFIG_BW320M)
...
_dprintf("*** Multicast IPTV: config Singtel TR069 on wan port ***\n");
	...
	case MODEL_RTAC68U:	/* WAN L1 L2 L3 L4 CPU */
		...
		if (nvram_match("switch_stb_x", "3")) {	// P3
			if (nvram_match("switch_wantag", "vodafone")) { //Config by robocfg
				...
				eval("swconfig", "dev", "switch0", "vlan", "1", "set", "ports", vlan_buf);
				sprintf(vlan_buf, "0 5");
				eval("swconfig", "dev", "switch0", "vlan", "2", "set", "ports", vlan_buf);
	...
	case MODEL_XT12:
		...
		if (nvram_match("switch_stb_x", "1") && nvram_match("switch_wantag", "none")) {
			...
			else if (model == MODEL_RTAX95Q || model == MODEL_XT8PRO || model == MODEL_XT8_V2 || model == MODEL_RTAXE95Q || model == MODEL_ET8PRO || model == MODEL_GTAX6000 || model == MODEL_GTAX11000_PRO || model == MODEL_GTAXE16000) {

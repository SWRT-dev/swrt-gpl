...
if( lacp_support
&& (based_modelid == "GT-AC5300" || based_modelid == "RT-AC86U" || based_modelid == "GT-AC2900" || based_modelid == "RT-AC87U" || based_modelid == "RT-AC5300" || based_modelid == "RT-AC88U" || based_modelid == "RT-AC3100" || based_modelid == "R7000P")){
...
function disable_lacp_if_conflicts_with_dualwan(){
	...
	if(wan_lanport_text!= ""){
		var hint_str1 = "This function is disabled because %1$@ is configured as %2$@."; //untranslated
		var hint_str2 = "If you want to enable it, please check <a id = \"setting_link\" target=\"_blank\" style=\"text-decoration:underline;\">here</a> to change settings.".replace("setting_link", "setting_link_1");//untranslated
...
function disable_lacp_if_conflicts_with_iptv(){
	...
	var hint_str2 = "If you want to enable it, please check <a id = \"setting_link\" target=\"_blank\" style=\"text-decoration:underline;\">here</a> to change settings.".replace("setting_link", "setting_link_2");//untranslated

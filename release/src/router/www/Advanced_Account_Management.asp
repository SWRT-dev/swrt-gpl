...
<head>
    ...
    <script type="text/javascript" src="/js/asus_pincode.js"></script>
    <script>
        ...
        function initial() {
            ...
            const pinCodeTitleComponent = new PinCodeTitleComponent();
            $('#pincode_title').append(pinCodeTitleComponent.render());
                        ...
                        <table width="760px" border="0" cellpadding="4" cellspacing="0" class="FormTitle"
                            ...
                            <tr>
                                <td bgcolor="#4D595D" valign="top">
                                    <div>&nbsp;</div>
                                    <div class="formfonttitle"><#menu5_6#> - Account Management</div>

        ...
        code += `
            <ul class="list-unstyled mb-0">
                <li role="menu">
                    ...
                    >
                        <div role="icon" class="icon-size-24 ${list.icon} icon-color-menu me-3 me-md-0"></div>
...
function goToSystem() {
	location.href = "/index.html?url=settings&current_theme=business&page=Advanced_System_Content.asp";
}

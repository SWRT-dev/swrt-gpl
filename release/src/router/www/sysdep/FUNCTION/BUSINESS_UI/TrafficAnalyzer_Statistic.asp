...
function initial(){
	if(parent.businessWrapper){	
		$("#tabMenu").hide()
		$("#traffic_unit").hide();
		$("#client_option").appendTo("#bu_client_option_container");
	}
...
function register_event(){
	...
	$( "#datepicker" ).datepicker({
		onSelect: function(){
			...
			document.getElementById('router').className = "block_filter_pressed block_filter_pressed_ta";
			document.getElementById('apps').className = "block_filter block_filter_ta";
...
function switch_content(obj){
	...
	document.getElementById('router').className = "block_filter block_filter_ta";
	document.getElementById('apps').className = "block_filter block_filter_ta";
	obj.className = "block_filter_pressed block_filter_pressed_ta";
...
function change_client(mac){
	...
	if(document.getElementById('router').className.indexOf("block_filter_pressed") != -1){
		info_type = "Clients";
	}
	else{
		info_type = "Apps";
...
function draw_flow(date, traffic){
	...
	if(parent.businessWrapper){
		parent.document.getElementById('bui_ta_daily').innerHTML = traffic_temp[0] + " " + traffic_temp[1];

		if(document.getElementById('duration_option').value == "monthly"){
			parent.document.getElementById('bui_ta_daily_title').innerHTML = "<#Traffic_Analyzer_monthly#>";
		}
		else if(document.getElementById('duration_option').value == "weekly"){
			parent.document.getElementById('bui_ta_daily_title').innerHTML = "<#Traffic_Analyzer_weekly#>";
		}
		else{		//daily
			parent.document.getElementById('bui_ta_daily_title').innerHTML = "<#Traffic_Analyzer_daily#>";
		}

		parent.document.getElementById('bui_ta_current_title').innerHTML = "<#Traffic_Analyzer_current#>";
		parent.document.getElementById('bui_ta_percent_title').innerHTML = "<#Traffic_Analyzer_usedpercent#>";
	}
}
							...
							<tr>
								<td bgcolor="#4D595D" colspan="3" valign="top">
									...
									<div style="margin-top:-20px;">
										<table class="hideForWrapper" width="100%">
											<tr>
...
if(dns_dpi_support) {
									...
									<div class="hideForWrapper formfontdesc"><#Traffic_Analyzer_desc#></div>

									<div style="display: flex">
										<div style="width:30%">
											<div style="font-size:16px;"><#Statistic_last_date#>:</div>
											<input class="input_12_table" id="datepicker" value="">
											<span id="statistic_hint" class="hint-color">* <#Traffic_Analyzer_note#></span>
										</div>
										<div style="display: flex;padding: 20px;width: 70%;">
											<div style="width: 100%;">
												<table>
													<tr>
														<td>
															<div>
																<table>
																	<tr>
																		...
																		<td>
																			<div id="router" style="" class="block_filter_pressed_ta block_filter_pressed" onclick="switch_content(this);"><#Permission_Management_Devices#></div>
																		</td>
																		<td>
																			<div id="apps" style="" class="block_filter block_filter_ta" onclick="switch_content(this);"><#Apps#></div>
																		</td>
																		<!--td>
															...
															<div>
																<table>
																	<tr>
																		...
																		<td id="bu_client_option_container">
											...
											<div class="clean_log hideForWrapper" onClick="clear_traffic_log();"></div>
											<div style="clear:both;"></div>
										</div>
									</div>

									<div class="analysis_bg">
										<div style="padding-top:5px;" class="hideForWrapper">
											<table style="width:99%;">
												<tr>
													...
													<td rowspan="2"; style="width:25%;text-align:center">
														<select class="input_option" id="client_option" onChange="change_client(this.value);"></select>
													</td>
												</tr>
												<tr>
										...
										<div id="traffic_chart_container">
											<canvas id="traffic_chart" width="1000px" height="300px"></canvas>
										</div>
									</div>
									...
									<div id="detail_info_block" class="analysis_bg" style="margin-top:10px;display:none"></div>
								</td>
							</tr>
						</table>
					</td>

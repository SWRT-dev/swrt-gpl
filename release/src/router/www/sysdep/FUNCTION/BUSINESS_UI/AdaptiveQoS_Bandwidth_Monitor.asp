...
.appIcons{
	width:36px;
	height:36px;
	background-image:url('https://nw-dlcdnet.asus.com/plugin/app_icons/3-144-0.png');
...
.qosLevel0{
	box-shadow: 0px 0px 0px 2px #F05353;
}
.qosLevel1{
	box-shadow: 0px 0px 0px 2px #FFC473;
}
.qosLevel2{
	box-shadow: 0px 0px 0px 2px #FFF73A;
}
.qosLevel4{
	box-shadow: 0px 0px 0px 2px #5EE3F6;
}
...
.speed-meter-100{
	background-image:url('images/New_ui/speedmeter.svg');
}
.qos_tab{
	background: #f5f5f5;
...
function show_clients(priority_type){
	...
	for(i=0; i<clientList.length; i++){
		...
		if(clientName.length > 23){
			...
			code += '<div title="' + clientObj.mac + '">'+ short_name +'</div>';
		}
		else{
			code += '<div title="' + clientObj.mac + '">'+ clientName +'</div>';
		}
			...
			<tr>
				<td  valign="top">
					<table width="100%" border="0" cellpadding="4" cellspacing="0">
								...
								<div class="border rounded-2 px-2 py-3" style="display: flex; justify-content: space-evenly;">
									<div id="upload_unit" style="display: flex; flex-direction: row; align-items: center;">
										<div style="display: flex; flex-direction: column;">
											...
											<div style="margin:0px;font-size:16px; color: #006ce1;"><#upload_bandwidth#></div>
										</div>
										...
										<div id="upload_speed_meter_bg" class="speed-meter-100" style="position: relative; height:188px;width:270px;background-repeat:no-repeat;margin:;">
											<div id="indicator_upload" class="transition_style" style="background-image:url('images/New_ui/indicator.svg');position:absolute;top: 40%;left: 50%;height:100px;width:50px;background-repeat:no-repeat;margin:0;"></div>
										</div>
										
									</div>	
									<div id="download_unit" style="display: flex; flex-direction: row; align-items: center;">
										<div style="display: flex; flex-direction: column;">
											<div id="download_speed" style="font-size:48px; line-height: 150%;">0.00</div>
											<div style="margin:0px;font-size:16px; color: #006ce1;"><#download_bandwidth#></div>
										</div>
										...
										<div id="download_speed_meter_bg" class="speed-meter-100" style="position: relative; height:188px;width:270px;background-repeat:no-repeat;margin:;">
											<div id="indicator_download" class="transition_style" style="background-image:url('images/New_ui/indicator.svg');position:absolute;top: 40%;left: 50%;height:100px;width:50px;background-repeat:no-repeat;margin:0;"></div>
										</div>
									</div>										
								</div>
							</td>
									...
									<table style="width: 100%;">
												...
												<div style="display:flex; align-items:center; justify-content:space-between;">
													...
													<div id="priority_block">
														<table>
															<tr>
																<td>
																	<div id="0" class="qos_tab" style="cursor:pointer;width:100px;border-radius:10px;text-align:center;z-index:100;" onclick="show_clients(this.id)">
																		<table>
																			<tr>
																...
																<td>
																	<div id="1" class="qos_tab" style="cursor:pointer;width:90px;border-radius:10px;text-align:center;z-index:100;" onclick="show_clients(this.id)">
																		<table>
																			<tr>
																...
																<td>
																	<div id="2" class="qos_tab" style="cursor:pointer;width:90px;border-radius:10px;text-align:center;z-index:100;" onclick="show_clients(this.id)">
																		<table>
																			<tr>
																...
																<td>
																	<div id="3" class="qos_tab" style="cursor:pointer;width:90px;border-radius:10px;text-align:center;z-index:100;" onclick="show_clients(this.id)">
																		<table>
																			<tr>
																...
																<td>
																	<div id="4" class="qos_tab" style="cursor:pointer;width:100px;border-radius:10px;text-align:center;z-index:100;" onclick="show_clients(this.id)">
																		<table>
																			<tr>
										...
										<tr style="display: none;">
											<td id="block_all" style="width:50%;font-family: Arial, Helvetica, sans-serif;text-align:left;padding-left:15px;visibility:hidden;">
												<div style="cursor:pointer;width:113px;border-radius:10px;text-align:center;" onclick="show_clients()">
													<table>
														<tr>
											...
											<td>
												<div id="priority_block" style="display: none;">
													<table>
														<tr>
															<td>
																<div id="0" class="qos_tab" style="cursor:pointer;width:100px;border-radius:10px;text-align:center;z-index:100;" onclick="show_clients(this.id)">
						...
						<tr>
							<td>
								<div colspan="2" class="monitor_qos_bg">
									<div id="sortable" style="padding: 8px 16px;">
						...
						<tr>
							<td>
								...
								<div class="apply_gen">
									<div class="titlebtn" onClick="applyRule();">
										<span><#CTL_apply#></span>
									</div>

...
if(based_modelid == "RT-AC5300" || based_modelid == "GT-AC5300" || based_modelid == "GT-AC9600" || based_modelid == "RT-AC3200" || based_modelid == "RT-AC3100" || based_modelid == "GT-AX11000" || based_modelid == "RT-AX92U" || based_modelid == "RT-AX95Q" || based_modelid == "XT8PRO" || based_modelid == "BT12" || based_modelid == "BQ16" || based_modelid == "BQ16_PRO" || based_modelid == "BM68" || based_modelid == "XT8_V2" || based_modelid == "RT-AXE95Q" || based_modelid == "ET8PRO" || based_modelid == "ET8_V2" || based_modelid == "RT-AX56_XD4" || based_modelid == "XD4PRO" || based_modelid == "CT-AX56_XD4" || based_modelid == "RT-AX58U" || based_modelid == "RT-AX58U_V2" || based_modelid == "TUF-AX3000" || based_modelid == "TUF-AX5400" || based_modelid == "DSL-AX82U" || based_modelid == "RT-AX82U" || based_modelid == "RT-AX56U" ||
...
based_modelid == "RT-AC66U" || based_modelid == "RT-AC56U" ||
		based_modelid == "RT-N66U" || based_modelid == "RT-N18U" || based_modelid == "XC5" || based_modelid == "EBA63" || based_modelid == "SBRAC3200P" || based_modelid == "R7000P"){
...
function Get_Component_Add_Client_PPTP(){
	...
	$("<div>").addClass("profile_title_item").append($("<span>").html("<#RouterConfig_GWStatic#> (<#feedback_optional#>)")).appendTo($content_container);
...
function Get_Component_Client_List_PPTP(_client_info){
	...
	const username = _client_info.username;
	var $client_content_bg = $("<div>").attr({"username":htmlEnDeCode.htmlEncode(username)}).addClass("client_content_bg").appendTo($container);
	...
	$("<div>").addClass("client_name").attr({"title":htmlEnDeCode.htmlEncode(username)}).html(htmlEnDeCode.htmlEncode(username)).appendTo($client_info_bg);
	...
	$("<div>").addClass("contorl_btn vpn_icon_all_collect edit_icon").unbind("click").click(function(e){
		...
		if($(".popup_container.popup_element").css("display") == "flex")
			$(".popup_container.popup_element").addClass("blur_effect");
		$(".popup_element_second").css("display", "flex");
		$(".popup_container.popup_element_second").empty().append(Get_Component_PPTP_Edit_Client(username));
	}).appendTo($client_contorl_bg);
...
function Get_Component_Setting_Profile_PPTP(_type){
	...
	$("<div>").addClass("profile_title_item").append($("<span>").html("<#vpnc_auth_for_clients#>")).appendTo($detail_general);

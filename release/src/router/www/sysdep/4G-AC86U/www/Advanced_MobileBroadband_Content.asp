		...
		<tr>
			<td>
				...
				<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
					...
					<tr><th>Phone Number</th><td><div id="modem_act_number"><% nvram_get("usb_modem_act_num"); %></div></td></tr><!--untranslated-->
		 		</table>
		 		</div>
	  		</td>
		</tr>
		...
		<tr>
			<td>
				...
				<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
					...
					<tr id="connection_type_tr" style="display:none;"><th>Connection Type</th><td><div id="connection_type"><% nvram_get("usb_modem_act_operation"); %></div></td></tr>
					<tr id="band_tr" style="display:none;"><th>Band</th><td><div id="band"></div></td></tr>
			...
			<td bgcolor="#4D595D" valign="top" height="680px">
				...
				<div style="margin:5px;" class="splitLine"></div>
	      		<div class="formfontdesc"><#WAN_page_desc#></div>			  
					...
					<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable"  style="margin-top:8px">
						...
						<tr>
							<th>Modem software version</th>
							<td>
								<div style="display: flex; align-items: center; flex-wrap: wrap;">
									<div id="usb_modem_act_swver" style="color: #FFFFFF; margin-right: 10px;"><% nvram_get("usb_modem_act_swver"); %></div>
									<div>
										<span><input name="reset_modem_btn" class="button_gen" type="button" onclick="reset_modem();" value="Reset Modem"/></span>
										<span><input name="reboot_modem_btn" class="button_gen" type="button" onclick="reboot_modem();" style="margin-left:10px;" value="Reboot Modem"/></span>
									</div>
								</div>
							</td>
						</tr>
				...
				<table id="traffic_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable" style="margin-top:8px">
				  ...
				  <tr id="sms_phone_tr" style="display: none">
					...
					<td>
						<input type="text" maxlength="16" class="input_15_table" id="modem_sms_phone" name="modem_sms_phone" value="<% nvram_get("modem_sms_phone"); %>" onblur="return check_mobile_number(this);" autocorrect="off" autocapitalize="off"/>
					</td>
				  </tr>
				</table>

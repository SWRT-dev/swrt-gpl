...
modem_act_band = '<% nvram_get("usb_modem_act_band"); %>';
modem_act_scc = '<% nvram_get("usb_modem_act_scc"); %>'.replace(",", ", ");
modem_band = modem_act_band + ((modem_act_scc != "")? (", "+ modem_act_scc) : "");
modem_act_rssi = '<% nvram_get("usb_modem_act_rssi"); %>';
modem_act_sinr = '<% nvram_get("usb_modem_act_sinr"); %>';

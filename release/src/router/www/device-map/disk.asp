...
function initial(){
	...
	if(!parent.diskUtility_support || usb_fatfs_mod != "tuxera" || (usb_ntfs_mod != "tuxera" && usb_ntfs_mod != "open") || usb_hfs_mod != "tuxera") {

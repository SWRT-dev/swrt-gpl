        ...
        <script>
            ...
            function generateControlChannel(prefix) {
                ...
                if (dfsSupport) {
                    ...
                    if (prefix === "5g1" && system.modelName === "ZenWiFi_BD4_Outdoor" && system.isEUSku) {
                        acsDfsSnippet = `<div id="5g1_acs_dfs_field" style="display:none"></div>`;
                    } else {
                        acsDfsSnippet = `
                ...
                if (no_zero_wait_dfs_support) {
                    noZeroWaitDfsSnippet += `
                        ...
                        parseInt(channelValue) >= 52 && parseInt(channelValue) <= 144 ? "" : "none"
                            ...
                            <span>        
                            Due to regulations and environmental factors, reconnecting between the main router and node takes longer with a fixed channel.
                            </span>
                        </div>
                    `;
                }

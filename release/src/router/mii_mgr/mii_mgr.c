...
#if !defined(CONFIG_SUPPORT_OPENWRT) && !defined(RTCONFIG_RALINK_MT7629) && !defined(RTCONFIG_RALINK_MT7622) && !defined(RTCONFIG_WLMODULE_MT7915D_AP) && !defined(RTCONFIG_RALINK_MT7621)

...
#else
static ssize_t ntfs_direct_IO(struct kiocb *iocb, struct iov_iter *iter, loff_t offset)
#endif
{
...
#else
static const char *ntfs_get_link(struct dentry *de, void **cookie)
#endif
{
	int err;
	char *ret;

...
static int parse_list_result(dbclient *client, char* prefix, fn_db_parse fn) {
    int n1, n2;
...
int dbclient_list(dbclient* client, char* prefix, fn_db_parse fn) {
    int n1;
    ...
    return parse_list_result(client, prefix, fn);
}

...
struct tevent_req *dcerpc_spoolss_EnumPrinters_send(TALLOC_CTX *mem_ctx,
						    ...
						    union spoolss_PrinterInfo **_info /* [out] [size_is(,*count),ref,switch_is(level)] */,
...
struct tevent_req *dcerpc_spoolss_GetPrinter_send(TALLOC_CTX *mem_ctx,
						  ...
						  DATA_BLOB *_buffer /* [in] [unique] */,
						  uint32_t _offered /* [in]  */,
						  union spoolss_PrinterInfo *_info /* [out] [subcontext(4),unique,subcontext_size(offered),switch_is(level)] */,
						  uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriver_send(TALLOC_CTX *mem_ctx,
							...
							DATA_BLOB *_buffer /* [in] [unique] */,
							uint32_t _offered /* [in]  */,
							union spoolss_DriverInfo *_info /* [out] [subcontext(4),unique,subcontext_size(offered),switch_is(level)] */,
							uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrintProcessorDirectory_send(TALLOC_CTX *mem_ctx,
								  ...
								  DATA_BLOB *_buffer /* [in] [unique] */,
								  uint32_t _offered /* [in]  */,
								  union spoolss_PrintProcessorDirectoryInfo *_info /* [out] [subcontext_size(offered),switch_is(level),subcontext(4),unique] */,
								  uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetForm_send(TALLOC_CTX *mem_ctx,
					       ...
					       DATA_BLOB *_buffer /* [in] [unique] */,
					       uint32_t _offered /* [in]  */,
					       union spoolss_FormInfo *_info /* [out] [subcontext(4),unique,subcontext_size(offered),switch_is(level)] */,
					       uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_EnumForms_send(TALLOC_CTX *mem_ctx,
						 ...
						 uint32_t _offered /* [in]  */,
						 uint32_t *_count /* [out] [ref] */,
						 union spoolss_FormInfo **_info /* [out] [switch_is(level),ref,size_is(,*count)] */,
						 uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriver2_send(TALLOC_CTX *mem_ctx,
							 ...
							 union spoolss_DriverInfo *_info /* [out] [unique,subcontext(4),switch_is(level),subcontext_size(offered)] */,
							 uint32_t *_needed /* [out] [ref] */,
...
struct tevent_req *dcerpc_spoolss_EnumPrinterKey_send(TALLOC_CTX *mem_ctx,
						      ...
						      union spoolss_KeyNames *_key_buffer /* [out] [subcontext(0),ref,switch_is(*_ndr_size),subcontext_size(*_ndr_size*2)] */,
						      uint32_t _offered /* [in]  */,
						      uint32_t *_needed /* [out] [ref] */);

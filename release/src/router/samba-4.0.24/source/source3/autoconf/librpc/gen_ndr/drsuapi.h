...
struct drsuapi_DsGetNCChangesMSZIPCtr1 {
	...
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),subcontext_size(compressed_length),unique,subcontext(4)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesMSZIPCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [subcontext(4),unique,subcontext_size(compressed_length),compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length)] */
}/* [nopush] */;

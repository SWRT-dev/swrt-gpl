...
struct bkrp_exported_RSA_key_pair {
	...
	DATA_BLOB public_exponent;/* [flag(LIBNDR_FLAG_REMAINING),subcontext_size(4),subcontext(0)] */
	...
	DATA_BLOB prime2;/* [subcontext(0),subcontext_size(128),flag(LIBNDR_FLAG_REMAINING)] */
	DATA_BLOB exponent1;/* [flag(LIBNDR_FLAG_REMAINING),subcontext_size(128),subcontext(0)] */
	...
	DATA_BLOB private_exponent;/* [subcontext(0),flag(LIBNDR_FLAG_REMAINING),subcontext_size(256)] */

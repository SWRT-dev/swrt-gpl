...
}/* [flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant,public,gensize,relative_base] */;
...
}/* [gensize,relative_base,nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE),public] */;
...
}/* [gensize,relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant,public] */;
...
}/* [relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant,public] */;
...
}/* [public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant,relative_base,gensize] */;
...
}/* [public,nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base] */;
...
struct spoolss_NotifyOptionType {
	...
	uint32_t u3;
	uint32_t count;
	union spoolss_Field *fields;/* [switch_is(type),size_is(count),unique] */
};
...
struct spoolss_PrinterEnumValues {
	...
	DATA_BLOB *data;/* [flag(LIBNDR_FLAG_REMAINING|ndr_spoolss_PrinterEnumValues_align(r->type)),subcontext_size(data_length),relative,subcontext(0)] */
	uint32_t data_length;/* [value(data?data->length:0)] */
}/* [public,gensize,relative_base] */;
...
struct spoolss_EnumPrinters {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_PrinterInfo **info;/* [size_is(,*count),ref,switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinter {
	...
	struct {
		union spoolss_PrinterInfo *info;/* [subcontext(4),unique,subcontext_size(offered),switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriver {
	...
	struct {
		union spoolss_DriverInfo *info;/* [subcontext(4),unique,subcontext_size(offered),switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrintProcessorDirectory {
	...
	struct {
		union spoolss_PrintProcessorDirectoryInfo *info;/* [subcontext_size(offered),switch_is(level),subcontext(4),unique] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetForm {
	...
	struct {
		union spoolss_FormInfo *info;/* [subcontext(4),unique,subcontext_size(offered),switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumForms {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_FormInfo **info;/* [switch_is(level),ref,size_is(,*count)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriver2 {
	...
	struct {
		union spoolss_DriverInfo *info;/* [unique,subcontext(4),switch_is(level),subcontext_size(offered)] */
		uint32_t *needed;/* [ref] */
...
struct spoolss_EnumPrinterKey {
	...
	struct {
		...
		union spoolss_KeyNames *key_buffer;/* [subcontext(0),ref,switch_is(*_ndr_size),subcontext_size(*_ndr_size*2)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;

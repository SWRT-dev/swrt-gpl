...
struct NEGOTIATE_MESSAGE {
	...
	const char * Workstation;/* [subcontext_size(WorkstationLen),flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM)),subcontext(0),relative] */
...
struct CHALLENGE_MESSAGE {
	...
	const char * TargetName;/* [relative,subcontext(0),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext_size(TargetNameLen)] */
	uint32_t NegotiateFlags;
...
struct AUTHENTICATE_MESSAGE {
	...
	union ntlmssp_NTLM_RESPONSE *NtChallengeResponse;/* [subcontext_size(NtChallengeResponseMaxLen),switch_is(NtChallengeResponseLen),subcontext(0),relative] */
	uint16_t DomainNameLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,DomainName))] */
	uint16_t DomainNameMaxLen;/* [value(DomainNameLen)] */
	const char * DomainName;/* [relative,subcontext(0),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext_size(DomainNameLen)] */
	...
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [relative,subcontext(0),subcontext_size(WorkstationLen),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags))] */

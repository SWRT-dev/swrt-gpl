...
wl -i eth6 eht features 7
wl -i eth6 up
wl -i eth6 phy_forcecal 1
wl -i eth6 phy_watchdog 0
wl -i eth6 2g_rate -t 11 -s 1 -i 0 --ldpc -b 20
...
wl -i eth7 eht features 7
wl -i eth7 up
wl -i eth7 phy_forcecal 1
wl -i eth7 phy_watchdog 0
wl -i eth7 5g_rate -t 11 -s 1 -i 0 --ldpc -b 80
...
wl -i eth8 band 6g
wl -i eth8 chanspec 6g161/20
wl -i eth8 eht features 7
wl -i eth8 up
wl -i eth8 phy_forcecal 1
wl -i eth8 phy_watchdog 0
wl -i eth8 6g_rate -t 11 -s 1 -i 1 --ldpc -b 20

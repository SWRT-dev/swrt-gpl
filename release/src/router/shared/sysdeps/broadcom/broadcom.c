...
//		printf("phystatus: [%x][%x][%x][%x]\n", regv, pmdv, regv2, pmdv2);
	...
	case MODEL_GTAX11000_PRO:
		/*
			5 1 2 3 4 6 7 W0 L1 L2 L3 L4 L5 L6
 		 */
		ports[0]=5; ports[1]=1; ports[2]=2; ports[3]=3; ports[4]=4; ports[5]=6; ports[6]=7;
		sprintf(pif[0], "%s", "eth0");
		sprintf(pif[1], "%s", "eth1");
		sprintf(pif[2], "%s", "eth2");
		sprintf(pif[3], "%s", "eth3");
...
phy_port_mapping get_phy_port_mapping(void)
{
	static phy_port_mapping port_mapping = {
		...
		.port[1] = { .phy_port_id = 1, .label_name = "L1", .cap = PHY_PORT_CAP_LAN, .max_rate = 1000, .ifname = "eth1" },
		.port[2] = { .phy_port_id = 2, .label_name = "L2", .cap = PHY_PORT_CAP_LAN, .max_rate = 1000, .ifname = "eth4" },
		.port[3] = { .phy_port_id = 3, .label_name = "L3", .cap = PHY_PORT_CAP_LAN, .max_rate = 1000, .ifname = "eth2" },
		.port[4] = { .phy_port_id = 4, .label_name = "L4", .cap = PHY_PORT_CAP_LAN, .max_rate = 1000, .ifname = "eth3" },
		.port[5] = { .phy_port_id = 6, .label_name = "L5", .cap = PHY_PORT_CAP_LAN, .max_rate = 2500, .ifname = "eth5" },
		.port[5] = { .phy_port_id = 7, .label_name = "L6", .cap = PHY_PORT_CAP_LAN, .max_rate = 2500, .ifname = "eth5" }
#endif

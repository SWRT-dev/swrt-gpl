...
static struct file_operations g_proc_file_vap_qos_seq_fops = {
	.owner		= THIS_MODULE,
...
#endif
	res = (int32_t)proc_create("vap_qos", 0600,
				g_ppa_mpe_proc_dir,
				&g_proc_file_vap_qos_seq_fops);
	res = (int32_t)proc_create("dbg", 0600,
				g_ppa_mpe_proc_dir,

...
MT_UINT32 WrapperFunction(int index)
{
    ...
    case 6 : return (MT_UINT32)dmem((MT_UBYTE)MT_BCL_arg[0],MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2]);
    case 7 : return (MT_UINT32)dreg16   ((MT_UBYTE)MT_BCL_arg[0],MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2]);
    case 8 : return (MT_UINT32)dreg32   ((MT_UBYTE)MT_BCL_arg[0],MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2]);
    case 9 : return (MT_UINT32)dreg8    ((MT_UBYTE)MT_BCL_arg[0],MT_BCL_arg[1],(MT_UBYTE)MT_BCL_arg[2]);

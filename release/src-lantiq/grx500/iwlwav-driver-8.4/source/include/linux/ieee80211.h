...
#define IEEE80211_HE_OPERATION_6GHZ_INFO_PRESENT			0x00020000
#define IEEE80211_HE_OPERATION_RESERVED								0x00fc0000
...
/* Extended Proxy ARP capability to be set in the 2nd byte of
 * the @WLAN_EID_EXT_CAPABILITY information element.
 */
#define WLAN_EXT_CAPA2_EXT_PROXY_ARP			BIT(4)

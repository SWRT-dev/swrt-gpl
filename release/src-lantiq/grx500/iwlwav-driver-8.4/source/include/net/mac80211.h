...
enum ieee80211_hw_flags {
	...
	IEEE80211_HW_SUPPORTS_PROXY_ARP,
 ...
 *	The callback can sleep.
 *
 * @handle_radar_debug: Notifier function that is called after informing
 * 	cfg80211 about the radar event, under an RTNL lock, in order to allow
 * 	the driver to perform debug operations on the DFS channels.
 *
 ...
 *
 * @notify_cac_started: notify the driver that CAC has started
 *
...
struct ieee80211_ops {
	...
	void (*notify_cac_started)(struct ieee80211_hw *hw,
	...
	int (*driver_free_netdev_allowed)(struct ieee80211_hw * hw, struct net_device * ndev);
...
/**
 * ieee80211_dfs_cac_restart - restart cac timer if cac is running.
 *
 * If FW/driver/HW have problems during cac, they may want to

...
mtlk_error_t          __MTLK_IFUNC wv_ieee80211_setup_register(struct device *dev, wv_mac80211_t *mac80211, mtlk_handle_t hw_handle);
...
void                  __MTLK_IFUNC wv_ieee80211_radar_detected(struct ieee80211_hw *hw, struct cfg80211_chan_def *chandef, uint8 rbm);

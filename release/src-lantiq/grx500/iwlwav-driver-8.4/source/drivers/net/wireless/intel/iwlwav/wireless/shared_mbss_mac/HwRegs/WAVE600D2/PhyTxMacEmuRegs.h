...
#define	REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_HE_SIGB_COMPRESSED          (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x229C)
#define	REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_HE_SIGB_16_SYMBOLS          (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22A0)
#define	REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_HE_TB_STARTING_STS          (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22A4)
#define	REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_NDP_FB_RU_TONE_SET_INDEX    (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22A8)
#define	REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_NDP_FB_STARTING_STS         (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22AC)
#define	REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_NDP_FB_VALUE                (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22B0)
...
/*REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_HE_SIGB_COMPRESSED 0x229C */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_HE_SIGB_16_SYMBOLS 0x22A0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_HE_TB_STARTING_STS 0x22A4 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_NDP_FB_RU_TONE_SET_INDEX 0x22A8 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_NDP_FB_STARTING_STS 0x22AC */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_MAC_EMU_TCR_USER_SELECT_NDP_FB_VALUE 0x22B0 */
typedef union
{
	uint32 val;
	struct

...
int __MTLK_IFUNC _mtlk_core_cfg_delete_sec_vaps(mtlk_handle_t hcore, const void *data, uint32 data_size);
...
int __MTLK_IFUNC mtlk_core_send_coex_config_req (mtlk_core_t *core, uint8 coex_mode, uint32 active_time, uint8 inactive_time);
...
int __MTLK_IFUNC mtlk_core_cfg_update_antenna_mask (mtlk_core_t *core, uint8 ant_mask);
int __MTLK_IFUNC wave_core_set_zwdfs_antenna (mtlk_handle_t hcore, const void *data, uint32 data_size);
int __MTLK_IFUNC wave_core_get_zwdfs_antenna (mtlk_handle_t hcore, const void* data, uint32 data_size);
...
void _mtlk_core_read_mu_ofdma_bf (mtlk_core_t *core, mtlk_mu_ofdma_bf_cfg_t *mu_ofdma_bf_cfg);
int  _wave_core_set_mu_ofdma_bf (mtlk_handle_t hcore, const void* data, uint32 data_size);
int  _wave_core_get_mu_ofdma_bf (mtlk_handle_t hcore, const void* data, uint32 data_size);
int __MTLK_IFUNC wave_core_set_mu_ofdma_bf (mtlk_core_t *core, mtlk_mu_ofdma_bf_cfg_t *mu_ofdma_bf_cfg);
...
int __MTLK_IFUNC wave_core_cfg_send_rcvry_msg         (mtlk_handle_t hcore, const void *data, uint32 data_size);
#endif

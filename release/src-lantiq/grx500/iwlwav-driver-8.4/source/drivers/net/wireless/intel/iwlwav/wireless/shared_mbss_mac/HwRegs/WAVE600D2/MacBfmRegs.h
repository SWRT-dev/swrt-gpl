...
typedef union
{
	...
	struct
	{
		...
		uint32 swBfeeSupportAllMuNg : 1; //Whether to support all Ng options or just a single one in MU response frames. , 1'b0 - use only minimal grouping , 1'b1 - use Ng from NDPA, reset value: 0x0, access type: RW
...
typedef union
{
	...
	struct
	{
		uint32 mbfmGlobalErrIrqEn : 16; //enable interrupts, reset value: 0x3ff, access type: RW
		uint32 reserved0 : 16;
	} bitFields;

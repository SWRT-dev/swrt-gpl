...
#define	REG_BA_ANALYZER_STA_MODE_CFG                               (BA_ANALYZER_BASE_ADDRESS + 0xAC)
...
#define	REG_BA_ANALYZER_LOGGER_FILTER0                             (BA_ANALYZER_BASE_ADDRESS + 0xC0)
#define	REG_BA_ANALYZER_LOGGER_FILTER1                             (BA_ANALYZER_BASE_ADDRESS + 0xC4)
#define	REG_BA_ANALYZER_BA_ANALYZER_SPARE                          (BA_ANALYZER_BASE_ADDRESS + 0xD0)
/*---------------------------------------------------------------------------------
...
/*REG_BA_ANALYZER_STA_MODE_CFG 0xAC */
typedef union
{
	uint32 val;
	struct
...
/*REG_BA_ANALYZER_LOGGER_FILTER0 0xC0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_BA_ANALYZER_LOGGER_FILTER1 0xC4 */
typedef union
{
	uint32 val;
	struct
...
/*REG_BA_ANALYZER_BA_ANALYZER_SPARE 0xD0 */
typedef union
{
	uint32 val;
	struct

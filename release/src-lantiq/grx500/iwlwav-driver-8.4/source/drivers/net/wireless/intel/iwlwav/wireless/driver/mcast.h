...
int  mtlk_mc_parse (mtlk_core_t* nic, mtlk_nbuf_t *nbuf, const IEEE_ADDR *sta_addr)
...
int  mtlk_mc_transmit (mtlk_core_t* nic, mtlk_core_handle_tx_data_t *tx_data, uint32 nbuf_flags, int bridge_mode, sta_entry *src_sta)
  __MTLK_INT_HANDLER_SECTION;
void mtlk_mc_add_sta (mtlk_core_t *nic, IEEE_ADDR *sta_addr);
void mtlk_mc_drop_sta (mtlk_core_t *nic, const unsigned char *mac);
#ifdef CONFIG_WAVE_DEBUG

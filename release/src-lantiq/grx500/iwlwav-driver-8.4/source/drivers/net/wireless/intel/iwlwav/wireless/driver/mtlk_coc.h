...
#define MTLK_COC_AUTO_OPT_CFG_PARAMS   (MTLK_COC_AUTO_RSSI_CFG_PARAMS  + MTLK_COC_AUTO_START_CFG_PARAMS)
...
#define MTLK_COC_ANT_MASK_CFG_PARAMS  MTLK_COC_NUM_ANTENNAS /* optional, mask per antenna */

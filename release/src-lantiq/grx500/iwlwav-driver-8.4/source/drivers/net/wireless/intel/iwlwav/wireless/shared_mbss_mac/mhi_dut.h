...
#define	FCSI_MAX_TOTAL_CHANNELS	5  //antenna0-3, central
...
{
	uint16 channelNum;
	uint16 channelShortRegData[RFIC_NUM_OF_SHORT_REGS];
	uint16 channelLongRegData[RFIC_NUM_OF_LONG_REGS];

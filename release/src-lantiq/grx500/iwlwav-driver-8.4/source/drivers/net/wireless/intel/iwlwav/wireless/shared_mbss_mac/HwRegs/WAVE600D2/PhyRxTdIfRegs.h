...
#define	REG_PHY_RX_TD_IF_PHY_RXTD_IF173                         (PHY_RX_TD_IF_BASE_ADDRESS + 0x15CC)
#define	REG_PHY_RX_TD_IF_PHY_RXTD_IF174                         (PHY_RX_TD_IF_BASE_ADDRESS + 0x1600)
...
#define	REG_PHY_RX_TD_IF_PHY_RXTD_IF117B                        (PHY_RX_TD_IF_BASE_ADDRESS + 0x161C)
...
typedef union
{
	...
	struct
	{
		uint32 muHostAntennaEnMaster : 5; //mu_host_antenna_en_master, reset value: 0x0, access type: RW
		uint32 reserved0 : 27;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiBusyAnt : 5; //no description, reset value: 0x0, access type: RO
		uint32 reserved0 : 27;
	} bitFields;
...
/*REG_PHY_RX_TD_IF_PHY_RXTD_IF173 0x15CC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyRxTdIfPhyRxtdIf173_u;

/*REG_PHY_RX_TD_IF_PHY_RXTD_IF174 0x1600 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_RX_TD_IF_PHY_RXTD_IF117B 0x161C */
typedef union
{
	uint32 val;
	struct

...
#define CHAN_PARAMS_CHAN_NUM_MAX				(165) //max channel in 5 giga is 165, max channel in 6 giga is 109, for now
...
typedef struct _UM_SET_CHAN_PARAMS
{
	...
	//word #54
	uint8 cts_to_self_duration; // Relevant in switch type = ST_DPP_ACTION only. This value indicates the CTS TO SELF duration in mSec.
	uint8 reserved[3];

...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved1 : 1;
		uint32 hestfExtraBackoffNdpFdbk : 7; //hestf_extra_backoff_ndp_fdbk , reset value: 0x0, access type: RW
		uint32 reserved2 : 9;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		...
		uint32 kpiBandwidthSupport : 4; //BW to support : , [0] – 20M , [1] – 40M , [2] – 80M , [3] – 160M, reset value: 0x7, access type: RW
		uint32 secondPhaseTrackingAddedSmoothingSnr : 8; //KPI smoothing snr added, reset value: 0xA, access type: RW
		uint32 kpiSphereCycles : 12; //KPI sphere cycles, reset value: 0x64, access type: RW
	} bitFields;

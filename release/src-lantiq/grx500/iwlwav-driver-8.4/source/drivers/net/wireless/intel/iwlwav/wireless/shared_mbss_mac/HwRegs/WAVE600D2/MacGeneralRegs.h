...
#define	REG_MAC_GENERAL_SEC_FILTER_IRQ                       (MAC_GENERAL_BASE_ADDRESS + 0xC0)
#define	REG_MAC_GENERAL_SEC_FILTER_IRQ_SHRD_RAM_CAUSE        (MAC_GENERAL_BASE_ADDRESS + 0xC4)
#define	REG_MAC_GENERAL_SEC_FILTER_IRQ_DESC_RAM_CAUSE        (MAC_GENERAL_BASE_ADDRESS + 0xC8)
#define	REG_MAC_GENERAL_SEC_FILTER_IRQ_APB_CAUSE             (MAC_GENERAL_BASE_ADDRESS + 0xCC)
...
typedef union
{
	...
	struct
	{
		...
		uint32 reserved0 : 3;
		uint32 apbBlockedAccessReturnPslverr : 1; //In secured mode, when a violated access occurs, this bit selects whether to reply with pslverr on APB interface., reset value: 0x1, access type: RW
		uint32 reserved1 : 3;
...
/*REG_MAC_GENERAL_SEC_FILTER_IRQ 0xC0 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 blockedAccessIrq : 1; //Main interrupt for any security filter detection, reset value: 0x0, access type: RO
		uint32 reserved0 : 3;
		uint32 shrdRamBlockedAccessIrq : 1; //Interrupt detected unallowed shared RAM access by either PCIe Host or the DMA, reset value: 0x0, access type: RO
		uint32 descRamBlockedAccessIrq : 1; //Interrupt detected unallowed descriptor RAM access by either PCIe Host or the DMA, reset value: 0x0, access type: RO
		uint32 apbBlockedAccessIrq : 1; //Interrupt detected unallowed APB access by PCIe Host, reset value: 0x0, access type: RO
		uint32 deliaBlockedAccessIrq : 2; //Interrupt detected unallowed shared RAM access by Delia unit . 2 bits per band., reset value: 0x0, access type: RO
		uint32 reserved1 : 7;
		uint32 shrdRamBlockedAccessIrqClr : 1; //Clear shrd_ram_blocked_access_irq    , reset value: 0x0, access type: WO
		uint32 descRamBlockedAccessIrqClr : 1; //Clear desc_ram_blocked_access_irq    , reset value: 0x0, access type: WO
		uint32 apbBlockedAccessIrqClr : 1; //Clear apb_blocked_access_irq         , reset value: 0x0, access type: WO
		uint32 delia0BlockedAccessIrqClr : 1; //Clear delia_blocked_access_irq bit 0 , reset value: 0x0, access type: WO
		uint32 delia1BlockedAccessIrqClr : 1; //Clear delia_blocked_access_irq bit 1 , reset value: 0x0, access type: WO
		uint32 reserved2 : 11;
	} bitFields;
} RegMacGeneralSecFilterIrq_u;

/*REG_MAC_GENERAL_SEC_FILTER_IRQ_SHRD_RAM_CAUSE 0xC4 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 shrdRamBlockedAccessAddrFetch : 22; //Address of the access that caused filter to set violation, reset value: 0x0, access type: RO
		uint32 reserved0 : 6;
		uint32 shrdRamMacSecurityLevelFetch : 2; //Mac security level during the violation.  , 1 - stage1 , 2 - stage2 , 3 - non-secured mode, reset value: 0x0, access type: RO
		uint32 shrdRamBlockedAccessWrFetch : 1; //1 - The violation was done by a write access , 0 - The violation was done by a read access, reset value: 0x0, access type: RO
		uint32 shrdRamBlockedAccessMaster : 1; //0 - The master that caused the violation is PCIe HOST , 1 - The master that caused the violation is DMA, reset value: 0x0, access type: RO
	} bitFields;
} RegMacGeneralSecFilterIrqShrdRamCause_u;

/*REG_MAC_GENERAL_SEC_FILTER_IRQ_DESC_RAM_CAUSE 0xC8 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 descRamBlockedAccessAddrFetch : 22; //Address of the access that caused filter to set violation, reset value: 0x0, access type: RO
		uint32 reserved0 : 6;
		uint32 descRamMacSecurityLevelFetch : 2; //Mac security level during the violation.  , 1 - stage1 , 2 - stage2 , 3 - non-secured mode, reset value: 0x0, access type: RO
		uint32 descRamBlockedAccessWrFetch : 1; //1 - The violation was done by a write access , 0 - The violation was done by a read access, reset value: 0x0, access type: RO
		uint32 descRamBlockedAccessMaster : 1; //0 - The master that caused the violation is PCIe HOST , 1 - The master that caused the violation is DMA, reset value: 0x0, access type: RO
	} bitFields;
} RegMacGeneralSecFilterIrqDescRamCause_u;

/*REG_MAC_GENERAL_SEC_FILTER_IRQ_APB_CAUSE 0xCC */
typedef union
{
	uint32 val;
	struct
	{
		uint32 apbBlockedAccessAddrFetch : 28; //Address of the access that caused filter to set violation, reset value: 0x0, access type: RO
		uint32 apbMacSecurityLevelFetch : 2; //Mac security level during the violation.  , 1 - stage1 , 2 - stage2 , 3 - non-secured mode, reset value: 0x0, access type: RO
		uint32 apbBlockedAccessWrFetch : 1; //1 - The violation was done by a write access , 0 - The violation was done by a read access, reset value: 0x0, access type: RO
		uint32 reserved0 : 1;
	} bitFields;
} RegMacGeneralSecFilterIrqApbCause_u;
...
typedef union
{
	...
	struct
	{
		uint32 swLsModeEnIram : 8; //no description, reset value: 0x0, access type: RW
		uint32 swDsModeEnIram : 8; //no description, reset value: 0x0, access type: RW
		uint32 reserved0 : 16;
	} bitFields;

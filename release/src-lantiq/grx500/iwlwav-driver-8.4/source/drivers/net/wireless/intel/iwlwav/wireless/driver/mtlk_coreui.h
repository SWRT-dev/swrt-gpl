...
typedef enum
{
  ...
  WAVE_RADIO_REQ_MBSS_VAP_DELETE_SEC_VAPS,      /*!< MBSS ReturnSecVaps issued by Master */
...
#define WAVE_TXOP_CFG_TXOP_DURATION_DEFAULT_2GHZ  WAVE_TXOP_CFG_TXOP_DURATION_MAX
#define WAVE_TXOP_CFG_TXOP_DURATION_DEFAULT_5GHZ  13300
...
#define WAVE_WEP_KEY_MAX_LENGTH             13
#define WAVE_WEP_NUM_DEFAULT_KEYS           4
...
#define NUM_IWPRIV_SCAN_PARAMS_BG 7
...
#define NUM_6GHZ_CHANS                  28  /* (59) 6 GHz channels 1,5,9,...,233 in the next phase */
#define NUM_6GHZ_CENTRAL_FREQS_BW40     (NUM_6GHZ_CHANS >> 1)
...
#define NUM_TOTAL_CHANS_6G              (NUM_6GHZ_CHANS + 3) /* (NUM_6GHZ_CHANS + 8)  - 8 holes (31,63,95,...231) in the next phase */

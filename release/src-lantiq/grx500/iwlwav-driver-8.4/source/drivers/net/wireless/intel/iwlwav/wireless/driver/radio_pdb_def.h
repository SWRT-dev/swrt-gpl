...
static const uint32 wave_radio_initial_RTS_thresh = 0xFFFF; /* Default in FW */
...
static const uint32 wave_radio_initial_scan_params_bg[7] = { 100, 20, 1, 1, 1, 1000, 5000 };
...
static const UMI_FIXED_LTF_AND_GI_REQ wave_radio_initial_fixed_ltf_and_gi_cfg = {1, 0, 0};
static const FIXED_POWER wave_radio_initial_fixed_pwr = {MTLK_PARAM_DB_INVALID_UINT8, 0, 0, 0};
...
static const mtlk_pdb_initial_value wave_radio_parameters[] =
{
  ...
  {PARAM_DB_RADIO_DYNAMIC_MC_RATE,                            PARAM_DB_TYPE_INT,     PARAM_DB_VALUE_FLAG_NO_FLAG,  sizeof(wave_radio_initial_invalid_uint32),  &wave_radio_initial_invalid_uint32},

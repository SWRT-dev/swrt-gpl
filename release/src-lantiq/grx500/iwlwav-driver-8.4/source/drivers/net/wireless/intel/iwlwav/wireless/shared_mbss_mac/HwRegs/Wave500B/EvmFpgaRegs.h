...
typedef union
{
	...
	struct
	{
		uint32 hypFcsiMasterStubActive:1;	// Enable FCSI master 
		uint32 reserved0:31;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiRstrq:1;	// FCSI master to slaves reset 
		uint32 reserved0:31;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiClkWrDivr:5;	// FCSI clock write divider
		uint32 reserved0:3;
		uint32 fcsiClkRdDivr:5;	// FCSI clock read divider
		uint32 fcsiRfMsSelect:1;	// 1'b1 - MS, 1'b0 - RF
		uint32 reserved1:18;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 _fcsiAddrA:7;	// FCSI address channel 0
		uint32 reserved0:25;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiWrDataA:16;	// FCSI write data channel 0
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiWrDataB:16;	// FCSI write data channel 1
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiWrDataC:16;	// FCSI write data channel 2
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiRdWr:1;	// 1'b1 - read, 1'b0 - write, Generates start pulse 
		uint32 reserved0:31;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiRdDataA:16;	// FCSI read data channel 0
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiRdDataB:16;	// FCSI read data channel 1
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 fcsiRdDataC:16;	// FCSI read data channel 2
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	{
		uint32 reserved0:9;
		uint32 mcsRank20:1;	// MCS Rank 2 for index 0
		uint32 reserved1:22;
	} bitFields;
...
typedef union
{
	...
	{
		uint32 reserved0:8;
		uint32 mcsNMode0:1;	// MCS N mode for index 0
		uint32 reserved1:23;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 mcsRate0:8;	// MCS rate for index 0
		uint32 reserved0:24;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 mcsRate1:8;	// MCS rate for index 1
		uint32 reserved0:24;
	} bitFields;
...
typedef union
{
	...
	{
		uint32 reserved0:8;
		uint32 mcsNMode1:1;	// MCS N mode for index 1
		uint32 reserved1:23;
	} bitFields;
...
typedef union
{
	...
	{
		uint32 reserved0:9;
		uint32 mcsRank21:1;	// MCS Rank 2 for index 1
		uint32 reserved1:22;
	} bitFields;
...
typedef union
{
	...
	{
		uint32 reserved0:1;
		uint32 usbSuspendPowerSaveEn:1;	// USB suspend power save enable
		uint32 reserved1:30;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 usbSuspendTestmodeEn:1;	// USB suspend testmode enable
		uint32 reserved0:31;
	} bitFields;
...
typedef union
{
	...
	{
		uint32 reserved0:9;
		uint32 mcsRank263:1;	// MCS Rank 2 for index 63
		uint32 reserved1:22;
	} bitFields;
...
typedef union
{
	...
	{
		uint32 reserved0:8;
		uint32 mcsNMode63:1;	// MCS N mode for index 63
		uint32 reserved1:23;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 mcsRate63:8;	// MCS rate for index 63
		uint32 reserved0:24;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 dphyRadioChannel:1;	// Dummy phy radio channel
		uint32 reserved0:31;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 dphyMediumBusyDelay:8;	// Dummy phy busy delay
		uint32 dphyMediumBusyTime:8;	// Dummy phy busy time
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 dphyMediumBusyArm:1;	// Dummy phy medium busy arm
		uint32 reserved0:31;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 dphyMediumBusyDelayTimer:8;	// Busy delay - current timer count
		uint32 dphyMediumBusyTimeTimer:8;	// Busy time - current timer count
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 dummyPhyModeEnable:1;	// Dummy phy enable
		uint32 reserved0:31;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 dummyPhyTxSwReset:1;	// Dummy phy Tx SW reset
		uint32 dummyPhyRxSwReset:1;	// Dummy phy Rx SW reset
		uint32 reserved0:30;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 resetTimeStamp:1;	// Reset time stamp counter
		uint32 reserved0:31;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 loggerMode:1;	// Logger mode - add time stamp value to the data written in the Sdram
		uint32 continuousMode:1;	// Continuous mode - data from the Sdram will be sent continuously to the Gpio
		uint32 dataFromGpio:1;	// Data from Gpio mode
		uint32 dataFromUsb:1;	// Data from Usb mode
		uint32 dataToHyperion:1;	// Data to Hyperion mode
		uint32 dataToUsb:1;	// Data to Usb mode
		uint32 cyclicMode:1;	// Cyclic mode - data from Gpio will be written continuously to the Sdram till "ffff" will be recetved
		uint32 stopFromRegisterMode:1;	// Stop from register mode -  data from Gpio will be written continuously to the Sdram till write 1 to the stop register
		uint32 reserved0:24;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 endAddress:32;	// Last address of the transaction in the Sdram
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 packetSizeRegister:16;	// Needed for Usb read transmition
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 packetEndDisable:1;	// For Usb
		uint32 usbAddr:2;	// For Usb
		uint32 crcMode:1;	// For Usb
		uint32 startOp20:1;	// Start write to Usb
		uint32 startOp21:1;	// Start read from Usb
		uint32 startOp0:1;	// Start Sdram write fifo
		uint32 startOp1:1;	// Start Sdram read fifo
		uint32 reserved0:24;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 offCntLimit:16;	// The register includes the delay between each start of the new data in continuous mode 
		uint32 reserved0:16;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 deepSwitchesVal:32;	// Read the deep switches values by host
	} bitFields;
} RegEvmFpgaDsw_u;
...
typedef union
{
	...
	struct
	{
		uint32 done0:1;	// Finish read from Sdram
		uint32 done1:1;	// Finish write to Sdram
		uint32 doneOp20:1;	// Usb read finished
		uint32 doneOp21:1;	// Usb write finished - valid with done_1 only
		uint32 reserved0:28;
	} bitFields;
} RegEvmFpgaDoneReg_u;
...
typedef union
{
	...
	struct
	{
		uint32 usbStartReadAddress:32;	// Will contain the stop address +dly_reg in cyclic mode
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 usbFifoAddress:2;	// 00 - using Fifo2 - usb2sdram; 10 - using Fifo6 - sdram2usb
		uint32 reserved0:30;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 versionReg:32;	// Version of the Fpga.
	} bitFields;

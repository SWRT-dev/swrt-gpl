...
#define MEMORY_MAP_UNIT_74_BASE_ADDRESS                                        (PCIE_PHY0_REGBLOCK_BASE_ADDR)
...
#define MEMORY_MAP_UNIT_1086_BASE_ADDRESS                                      (SHARED_RAM_WHITE_BASE_ADDR)
#define MEMORY_MAP_UNIT_1088_BASE_ADDRESS                                      (B0_MPDU_DESC_MEM_BASE_ADDR)
#define MEMORY_MAP_UNIT_1089_BASE_ADDRESS                                      (SHARED_RAM_BLACK_BASE_ADDR)

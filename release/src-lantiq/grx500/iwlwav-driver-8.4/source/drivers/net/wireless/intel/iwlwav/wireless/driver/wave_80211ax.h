...
#define HE_OPERATION_BSS_COLOR_5GHZ_2STS        0x5  /* BSS color value for 5GHz band and 2 STS */
...
#define HE_OPERATION_CAP4_IDX 4
#define HE_OPERATION_CAP5_IDX 5
#define HE_OPERATION_CAP6_IDX 6
#define HE_OPERATION_LEN    (HE_OPERATION_CAP6_IDX + 1)

/* HE non advertised capabilities definitions */
#define HE_NON_ADVERT_CAP0    0x01
#define HE_NON_ADVERT_CAP1    0x0b
#define HE_NON_ADVERT_CAP2    0x00
#define HE_NON_ADVERT_CAP3    0x12
#define HE_NON_ADVERT_CAP3_D2 0x18
#define HE_NON_ADVERT_CAP4    0x00
#define HE_NON_ADVERT_CAP5    0x08
#define HE_NON_ADVERT_CAP6    0x00
#define HE_NON_ADVERT_CAP7    0x10
#define HE_NON_ADVERT_CAP8    0x02
#define HE_NON_ADVERT_CAP9    0x00
#define HE_NON_ADVERT_CAP9_D2 0x09
#define HE_NON_ADVERT_CAP10   0x00
#define HE_NON_ADVERT_CAP11   0xc0
#define HE_NON_ADVERT_CAP12   0x03
#define HE_NON_ADVERT_CAP13   0x1c
#define HE_NON_ADVERT_CAP14   0x08

#define HE_NON_ADVERT_CAP0_IDX  0
#define HE_NON_ADVERT_CAP1_IDX  1
#define HE_NON_ADVERT_CAP2_IDX  2
#define HE_NON_ADVERT_CAP3_IDX  3
#define HE_NON_ADVERT_CAP4_IDX  4
#define HE_NON_ADVERT_CAP5_IDX  5
#define HE_NON_ADVERT_CAP6_IDX  6
#define HE_NON_ADVERT_CAP7_IDX  7
#define HE_NON_ADVERT_CAP8_IDX  8
#define HE_NON_ADVERT_CAP9_IDX  9
#define HE_NON_ADVERT_CAP10_IDX 10
#define HE_NON_ADVERT_CAP11_IDX 11
#define HE_NON_ADVERT_CAP12_IDX 12
#define HE_NON_ADVERT_CAP13_IDX 13
#define HE_NON_ADVERT_CAP14_IDX 14
#define HE_NON_ADVERTISED_LEN   (HE_NON_ADVERT_CAP14_IDX + 1)

...
#define	REG_TX_SELECTOR_TX_SEL_TIM_STA_BITMAP_SEL                 (TX_SELECTOR_BASE_ADDRESS + 0x190)
...
/*REG_TX_SELECTOR_TX_SEL_TIM_STA_BITMAP_SEL 0x190 */
typedef union
{
	uint32 val;
	struct
...
} RegTxSelectorTxSelTimStaBitmapSel_u;

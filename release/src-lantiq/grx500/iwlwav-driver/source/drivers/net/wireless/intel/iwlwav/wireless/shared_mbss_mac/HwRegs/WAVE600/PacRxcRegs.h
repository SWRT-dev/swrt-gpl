...
#define	REG_PAC_RXC_CIR_BUF_MON_SM_USR0TO15                    (PAC_RXC_BASE_ADDRESS + 0x70)
#define	REG_PAC_RXC_CIR_BUF_MON_SM_USR16TO31                   (PAC_RXC_BASE_ADDRESS + 0x74)
#define	REG_PAC_RXC_CIR_BUF_MON_SM_USR32TO35                   (PAC_RXC_BASE_ADDRESS + 0x78)
...
typedef union
{
	...
	struct
	{
		...
		uint32 mbfmFifoUpdateEn : 1; //Enable filling the FIFO of MAC BF module, reset value: 0x1, access type: RW
...
typedef union
{
	...
	struct
	{
		...
		uint32 rxGloblNegationMissingMetricsErrIrq : 1; //IRQ of Rx ready negation without or missing metrics, reset value: 0x0, access type: RO
...
typedef union
{
	...
	struct
	{
		...
		uint32 rxGloblNegationMissingMetricsErrIrqEn : 1; //Enable IRQ of Rx ready negation without or missing metrics, reset value: 0x0, access type: RW
...
typedef union
{
	...
	struct
	{
		...
		uint32 rxGloblNegationMissingMetricsErrIrqClr : 1; //Clear IRQ of Rx ready negation without or missing metrics, by write '1', reset value: 0x0, access type: WO
		uint32 reserved0 : 29;
	} bitFields;
...
/*REG_PAC_RXC_CIR_BUF_MON_SM_USR0TO15 0x70 */
typedef union
{
	uint32 val;
	struct
...
} RegPacRxcCirBufMonSmUsr0To15_u;

/*REG_PAC_RXC_CIR_BUF_MON_SM_USR16TO31 0x74 */
typedef union
{
	uint32 val;
	struct
...
} RegPacRxcCirBufMonSmUsr16To31_u;

/*REG_PAC_RXC_CIR_BUF_MON_SM_USR32TO35 0x78 */
typedef union
{
	uint32 val;
	struct
...
} RegPacRxcCirBufMonSmUsr32To35_u;
...
typedef union
{
	...
	struct
	{
		uint32 rxfFifoRdEntriesNum : 8; //RXF FIFO number of entries to decrement., reset value: 0x0, access type: RW
		uint32 reserved0 : 24;
	} bitFields;

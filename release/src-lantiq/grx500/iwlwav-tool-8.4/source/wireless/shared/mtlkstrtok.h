...
/*! \fn      int mtlk_strtok_init(mtlk_strtok_t *strtok_obj)
    \brief   Initiates MTLK String Tokenizer object.

    This function initializes internals of MTLK String Tokenizer object.

    \param   strtok_obj MTLK String Tokenizer object

    \return  MTLK_ERR... code
*/
int __MTLK_IFUNC mtlk_strtok_init(mtlk_strtok_t *strtok_obj);

/*! \fn      int mtlk_strtok_parse(mtlk_strtok_t *strtok_obj,
                                   const char    *str, 
                                   char           delimiter)
    \brief   Parses string.
    ...
    \return  MTLK_ERR... code
*/
int         __MTLK_IFUNC mtlk_strtok_parse(mtlk_strtok_t *strtok_obj,
                                           const char    *str, 
                                           char           delimiter);

/*! \fn      int mtlk_strtok_add_token(mtlk_strtok_t *strtok_obj,
                                       const char    *token)
    \brief   Adds token.
    ...
    \return  MTLK_ERR... code
*/
int __MTLK_IFUNC mtlk_strtok_add_token(mtlk_strtok_t *strtok_obj,
                                       const char    *token);

/*! \fn      int mtlk_strtok_get_nof_tokens(mtlk_strtok_t *strtok_obj)
...
*/
uint32 __MTLK_IFUNC mtlk_strtok_get_nof_tokens(const mtlk_strtok_t *strtok_obj);

/*! \fn      int mtlk_strtok_get_token(mtlk_strtok_t *strtok_obj, uint32 idx)
...
*/
const char* __MTLK_IFUNC mtlk_strtok_get_token(const mtlk_strtok_t *strtok_obj, uint32 idx);

/*! \fn      void mtlk_strtok_purge(mtlk_strtok_t *strtok_obj)
    ...
    \param   strtok_obj MTLK String Tokenizer object
*/
void        __MTLK_IFUNC mtlk_strtok_purge(mtlk_strtok_t *strtok_obj);

/*! \fn      void mtlk_strtok_cleanup(mtlk_strtok_t *strtok_obj)
    ...
    \param   strtok_obj MTLK String Tokenizer object
*/
void __MTLK_IFUNC mtlk_strtok_cleanup(mtlk_strtok_t *strtok_obj);

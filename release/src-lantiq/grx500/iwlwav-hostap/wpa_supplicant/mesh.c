				    ...
				    struct hostapd_freq_params *freq)
{
	...
	if (conf->hw_mode == HOSTAPD_MODE_IEEE80211A && ssid->vht) {
		...
		case CHANWIDTH_80P80MHZ:
			...
			hostapd_set_oper_centr_freq_seg0_idx(conf, hostapd_get_oper_centr_freq_seg0_idx(conf) + ssid->ht40 * 2);
			break;
		case CHANWIDTH_160MHZ:
			ieee80211_freq_to_chan(
				...
				&hostapd_get_oper_centr_freq_seg0_idx(conf));
			hostapd_set_oper_centr_freq_seg0_idx(conf, hostapd_get_oper_centr_freq_seg0_idx(conf) + ssid->ht40 * 2);
			hostapd_set_oper_centr_freq_seg0_idx(conf, hostapd_get_oper_centr_freq_seg0_idx(conf) + (40 / 5));
			break;
		}

...
static int hostapd_cli_cmd_dpp_enable_cc(struct wpa_ctrl *ctrl, int argc,
					  char *argv[])
{
    return hostapd_cli_cmd(ctrl, "DPP_ENABLE_CC", 1, argc, argv);
}
#endif /* CONFIG_DPP2 */
#endif /* CONFIG_DPP */
...
static const struct hostapd_cli_cmd hostapd_cli_commands[] = {
	...
	{ "dpp_stop_chirp", hostapd_cli_cmd_dpp_stop_chirp, NULL,
	  "= stop DPP chirp" },
	{ "dpp_enable_cc", hostapd_cli_cmd_dpp_enable_cc, NULL,
	  "enable=1, disable=0" },
#endif /* CONFIG_DPP2 */
#endif /* CONFIG_DPP */

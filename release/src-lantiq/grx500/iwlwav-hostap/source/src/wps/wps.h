...
#ifdef CONFIG_DPP2
	/**
	 * WPS_EV_RX_DPP_URI - Received DPP URI
	 */
	WPS_EV_RX_DPP_URI,

	/**
	 * WPS_EV_TX_DPP_URI - Transmit DPP URI
	 */
	WPS_EV_TX_DPP_URI
#endif /* CONFIG_DPP2 */
};
...
#ifdef CONFIG_DPP2
	struct wps_event_rx_dpp_uri {
		u8 dpp_bootstrap_uri[DPP_BOOTSTRAP_URI_MAX_LEN];
	} rx_dpp_uri;
#endif /* CONFIG_DPP2 */
};

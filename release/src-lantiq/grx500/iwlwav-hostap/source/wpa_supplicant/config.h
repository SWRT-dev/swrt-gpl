...
#define DEFAULT_P2P_GO_FREQ_MOVE P2P_GO_FREQ_MOVE_STAY
	...
	/**
	 * dpp_wps_bootstrapping_config - If enabled use WPS for bootstrapping in DPP
	 *
	 * 0 = Does not use WPS for bootstrapping in DPP
	 * 1 = Use WPS way of bootstrapping in DPP; Bootstrap information or URI is sent
	 * 	in encrypted settings field of M7 during WPS handshake
	 */
	int dpp_wps_bootstrapping_config;

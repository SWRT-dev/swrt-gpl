...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/paldier/lean/staging_dir/toolchain-arm_cortex-a9_gcc-8.4.0_musl_eabi/arm-openwrt-linux-muslgnueabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{

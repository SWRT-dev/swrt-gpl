...
enum opt_code
{
  ...
  OPT_mapcs = 1196,                          /* -mapcs */
  OPT_mapcs_frame = 1197,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1198,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1199,              /* -mapcs-stack-check */
  OPT_march_ = 1200,                         /* -march= */
  OPT_marm = 1201,                           /* -marm */
  OPT_masm_syntax_unified = 1202,            /* -masm-syntax-unified */
  OPT_mbe32 = 1203,                          /* -mbe32 */
  OPT_mbe8 = 1204,                           /* -mbe8 */
  OPT_mbig_endian = 1205,                    /* -mbig-endian */
  OPT_mbionic = 1206,                        /* -mbionic */
  OPT_mbranch_cost_ = 1207,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1208,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1209,     /* -mcaller-super-interworking */
  OPT_mcmse = 1210,                          /* -mcmse */
  OPT_mcpu_ = 1211,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1212,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1213,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1214,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1215,                  /* -mfp16-format= */
  OPT_mfpu_ = 1216,                          /* -mfpu= */
